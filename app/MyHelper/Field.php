...
class Field
{
    ...
    {
        return view('form-fields.time',compact('name','label','value'))->render();
    }
    ...
    public static function number($name, $label, $value= null , $array = [])
    {
        ...
        return view('form-fields.number',compact('name','label','value','step'))->render();
    }
    ...
    public static function ajaxBtn($name, $array = [] , $type = 'submit'):string
    {
        ...
        return view('form-fields.ajax-btn',compact('name','class','type','id'))->render();
    }
    ...
    {
        return view('form-fields.editor',compact('name','label','value','plugin'))->render();
    }
